...

{
  ...
  fileSystems."/" =
    {
      device = "/dev/disk/by-uuid/82841424-34c1-42a8-8243-39d56c456ddd";
      fsType = "ext4";
    };

  fileSystems."/boot" =
    {
      device = "/dev/disk/by-uuid/108D-1A81";
      fsType = "vfat";
      options = [ "fmask=0077" "dmask=0077" ];
    };

  swapDevices =
    [{ device = "/dev/disk/by-uuid/2bb6644d-4c61-4702-82c6-2a4b74b820c5"; }];
